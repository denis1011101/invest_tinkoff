      ...
      module Api
        module Contract
          module V1
            ...
            GetBankAccountsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("tinkoff.public.invest.api.contract.v1.GetBankAccountsRequest").msgclass
            GetBankAccountsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("tinkoff.public.invest.api.contract.v1.GetBankAccountsResponse").msgclass
            BankAccount = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("tinkoff.public.invest.api.contract.v1.BankAccount").msgclass
            CurrencyTransferRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("tinkoff.public.invest.api.contract.v1.CurrencyTransferRequest").msgclass
            CurrencyTransferResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("tinkoff.public.invest.api.contract.v1.CurrencyTransferResponse").msgclass
